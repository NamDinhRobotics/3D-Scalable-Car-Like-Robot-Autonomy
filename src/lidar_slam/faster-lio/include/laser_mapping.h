...
class LaserMapping {
   public:
    ...
    void ObsModel(const state_ikfom &s, esekfom::dyn_share_datastruct<double> &ekfom_data);
   ...
   private:
    ...
    void PointBodyToWorld(PointType const *pi, PointType *const po) const;
    void PointBodyToWorld(const common::V3F &pi, PointType *const po) const;
    void PointBodyLidarToIMU(PointType const *const pi, PointType *const po) const;
